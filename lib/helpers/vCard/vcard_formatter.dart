// Got unmaintained from: https://pub.dev/packages/vcard_maintained
...
class VCardFormatter {
  ...
  String getFormattedAddress(
    ...
    if (address.label.isNotEmpty ||
      ...
      if (majorVersion >= 4) {
        formattedAddress =
            'ADR$encodingPrefix;TYPE=${address.type}${address.label.isNotEmpty ? ';LABEL="${e(address.label)}"' : ''}:;;${e(address.street)};${e(address.city)};${e(address.stateProvince)};${e(address.postalCode)};${e(address.countryRegion)}${nl()}';
      } else {
        if (address.label.isNotEmpty) {
          formattedAddress =
              'LABEL$encodingPrefix;TYPE=${address.type}:${e(address.label)}${nl()}';
        }
        formattedAddress +=
            'ADR$encodingPrefix;TYPE=${address.type}:;;${e(address.street)};${e(address.city)};${e(address.stateProvince)};${e(address.postalCode)};${e(address.countryRegion)}${nl()}';
      }
    }
  ...
  String getFormattedString(VCard vCard) {
    ...
    for (var name in [vCard.firstName, vCard.middleName, vCard.lastName]) {
    ...
    formattedVCardString +=
        'N$encodingPrefix:${e(vCard.lastName)};${e(vCard.firstName)};${e(vCard.middleName)};${e(vCard.namePrefix)};${e(vCard.nameSuffix)}${nl()}';
    ...
    if (vCard.email != null) {
      ...
      vCard.email.forEach((address) {
        if (majorVersion >= 4) {
          ...
          formattedVCardString +=
              'EMAIL$encodingPrefix;type=HOME,INTERNET:${e(address)}${nl()}';
        } else {
          formattedVCardString +=
    ...
    if (vCard.workEmail != null) {
      ...
      vCard.workEmail.forEach((address) {
        if (majorVersion >= 4) {
          ...
          formattedVCardString +=
              'EMAIL$encodingPrefix;type=WORK,INTERNET:${e(address)}${nl()}';
        } else {
          formattedVCardString +=
    ...
    if (vCard.otherEmail != null) {
      ...
      vCard.otherEmail.forEach((address) {
        if (majorVersion >= 4) {
          ...
          formattedVCardString +=
              'EMAIL$encodingPrefix;type=OTHER,INTERNET:${e(address)}${nl()}';
        } else {
          formattedVCardString +=
